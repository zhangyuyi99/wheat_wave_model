...
x_wind_gain = -400; % Applied force per height difference
x_wind_amplitude = 0.7;
x_wind_bias = 0;
x_wind_frequency = 4; % rad/s

y_wind_gain = -400; % Applied force per height difference
...
height_offset = 0.1*randn(10,10);


sim('wheat_field_sine_wind_random_height','StartTime','0','StopTime',num2str(time),'FixedStep',num2str(time_step));
% 
% smwritevideo('wheat_field_sine_wind_random_height', 'videos/wheat_field_sine_wind',...
